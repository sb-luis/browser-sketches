...
/** Builds a Three.js Group of border lines from a GeoJSON FeatureCollection. */
export function createBordersFromGeoJSON(geoJSON, material) {
  const group = new THREE.Group();
  group.name = 'country-borders-110m';
